...
function loadBookshelf() {
  ...
  books.forEach((book,index)=> {
    ...
    <h3 style=" position:absolute; left:35%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${book.name}</h3>
      <img src="${book.cover}" alt="Cover" style="width:100px; height:100px; object-fit:; border-radius: 8px; border:1px solid #ddd;">
      <span onclick="alert('Download is not available');" style="position:fixed;right:5%; margin-top:16%"><svg width="30" height="30" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
...
function openBook(index) {
  ...
  const modalHTML = `
    <div id="whole" style="display: flex; flex-direction: column; height: 100%; background:;">
      <!-- Header -->
